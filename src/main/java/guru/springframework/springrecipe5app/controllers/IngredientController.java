...
import guru.springframework.springrecipe5app.services.IngredientService;
import guru.springframework.springrecipe5app.services.RecipeService;
import guru.springframework.springrecipe5app.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String deleteById(@PathVariable String recipeId,@PathVariable String id) {
        log.debug("Checking recipe id: " + recipeId);
